...
class FolderLinksViewModel(
    ...
    ContainerHost<FolderLinksState, FolderLinksSideEffect> {
    ...
    private fun loadFirstPage() =
        intent {
            ...
            getBookmarksUseCase(folderId = folderId, page = 1, limit = PAGE_SIZE)
                .onSuccess { bookmarks ->
                    reduce {
                        state.copy(
                            bookmarks = bookmarks,
    ...
    fun loadMore() =
        intent {
            ...
            getBookmarksUseCase(folderId = folderId, page = nextPage, limit = PAGE_SIZE)
